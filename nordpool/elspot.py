# From https://github.com/kipe/nordpool
...
class Prices(object):
    ...
    def _fetch_json(self, data_type, end_date=None):
        ...
        print self.API_URL % data_type
        #print 'currency': self.currency,'endDate': end_date.strftime('%d-%m-%Y')}
    ...
    """
    def fetch-data(self, reqtype, area, interval):
        
        url = API_URL + str(reqtype+area+interval)
